...
The first model reached an F1 score of 0.9934 with sensitivity 0.9869 and specificity 1.0.
The second model reached an F1 score of 1 with sensitivity 1 and specificity 1. That shows, that the second model had a perfect prediction for the test set.
...
The feature values 'c', 'f', 'l', 'm', 'p', 's', 'y' for the attribute odor can give us a classification. With this information we can classify 3,689 mushrooms.
...
The classification model will be evaluated with the F1 score. This score includes not only the overall accuracy, it considers the prediction specificity and sensitivity too.
